...
const Hero = () => {
  return (
    <div className="relative items-center justify-center h-screen bg-primary">
    {/* This div contains the text 
    <div className='title-container animate__animated animate__fadeInDown'>
      <h1 className='text-secondary font-normal lg:text-4xl md:text-[1.4rem] text-center  md:mt-12'>CONECTIVIDAD, ESTILO <br /><span className='lg:text-4xl md:text-[1.4rem] font-bold text-secondary tracking-wider '>Y CALIDAD DE VIDA .</span></h1>
    </div>
