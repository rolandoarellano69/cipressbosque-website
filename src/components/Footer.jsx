...
const Footer = () => {
  return (
    ...
    <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8 lg:py-24 flex flex-col lg:flex-row items-center justify-between">
      ...
      <ul className='flex flex-col sm:flex-row items-center justify-center gap-4 mt-14 mb-8'>
        <li className='list-none flex items-center gap-2 text-lg sm:text-sm'> <RiMapPinLine className='text-lg sm:text-xl' />Plaza Carrusel LA002</li>
        <li className='list-none flex items-center gap-2 text-lg sm:text-sm'> <RiPhoneLine className='text-lg sm:text-xl' />6644049399</li>
        <li className='text-lg sm:text-sm mt-2 sm:mt-0'>Lunes a Viernes : 9:00 am-6:00 pm</li>
        <li className='text-lg sm:text-sm mt-2 sm:mt-0'>Sábado 9:00 am-2 pm</li>
        </ul>
        ...
        <ul className="flex flex-wrap justify-center gap-6 md:gap-8">
          ...
          <li>
            <Link className="hover:border-b-2 hover:border-gray-200 text-gray-200 transition hover:text-gray-200/75 cursor-pointer" href="/">
              Contacto
            </Link>
          </li>
        </ul>
