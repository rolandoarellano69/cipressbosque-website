...
function Formulario() {
  ...
  return (
    <div id="form" className="flex flex-col items-center justify-center  h-full">
      <div className='py-6 mb-8 bg-white w-full text-secondary'>
      <h2 className=" flex justify-center items-center md:text-2xl lg:text-4xl xl:text-5xl font-semibold mb-3 w-full text-secondary text-center gap-2 py-6 bg-white">CONTÁCTANOS
